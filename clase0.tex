...
\end{figure}		
	...
	\noindent\fbox{%
    \parbox{\textwidth}{%
		 \textbf{Ayuda:} puede ser útil buscar la documentación de la función \textit{abline()} para agregar líneas punteadas de referencia.
    }%
}
	\end{parte}
...
\end{figure}		
	...
	\noindent\fbox{%
    \parbox{\textwidth}{%
		 \textbf{Ayuda:} puede ser útil buscar la documentación de la función \textit{axis()} para dibujar los ejes independientemente.
    }%
}
	\end{parte}	
...
\begin{figure}[!ht]
    ...
    \fbox{\includegraphics[width=0.6\textwidth]{hist2.png}}
    \caption{Edad de los pacientes}
    \label{fig:hist2}
\end{figure}	
...
\begin{figure}[!ht]
    ...
    \fbox{\includegraphics[width=0.6\textwidth]{hist3.png}}
    \caption{Edad de los pacientes}
    \label{fig:hist3}
\end{figure}	
...
\begin{figure}[!ht]
    ...
    \fbox{\includegraphics[width=0.6\textwidth]{boxplot.png}}
    \caption{Edad de los pacientes}
    \label{fig:boxplot}
\end{figure}	
...
\begin{figure}[!ht]
    ...
    \fbox{\includegraphics[width=0.6\textwidth]{boxplot2.png}}
    \caption{Edad de los pacientes según el sexo}
    \label{fig:boxplot2}
\end{figure}	

	El gráfico anterior puede ser generado nuevamente con la función \textit{boxplot}, utilizando el parámetro \textit{formula}. Hágalo.\\
	
	\noindent\fbox{%
    \parbox{\textwidth}{%
		 \textbf{Ayuda:} el parámetro \textit{formula} toma algo de la forma \textit{y $\thicksim$ grp}, donde \textit{y} es un vector numérico de datos que serán distribuidos en grupos, acordes a la variable \textit{grp} (usualmente un factor). 
